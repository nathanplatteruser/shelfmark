...
- Camera stack, single, and hunt ISBN (webcam, phone, or grocery-gun HID).
- Two-tone POS beep.
...
- Hunt: aisle ping-pong. Scan one ISBN, hear the max acquisition price (sale minus shop/envelope/stamp minus the keep). Next book. Does not add to inventory.
